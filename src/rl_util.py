...
def load_healthy_data(max_ba_flow, gut_deconj_freq_co_multiplier, gut_biotr_freq_CA_multiplier):

    # Load healthy bile acid states
    x0 = np.array([56.9562,   95.5388,   44.6192, 2484.5113, 4237.4856, 1960.6781,
                  112.4558,   64.2761,   41.7227,    2.9839,   68.7451,   43.8859,
                   65.0613,   38.9473,   24.7599,   99.3816,  116.4829, 1382.8322,
                    1.1832,    7.955 ,    3.6613,    0.2527,    0.1055,    0.9385])
    ...
    sips_param[11] *= gut_deconj_freq_co_multiplier
    sips_param[13] *= gut_biotr_freq_CA_multiplier
