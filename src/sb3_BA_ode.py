...
def BA_ode(t, state, param):
    ...
    dsi_out_au_cCA_multiplier   = 1.
    dsi_out_au_cCDCA_multiplier = 1.
    dsi_out_au_cSBA_multiplier  = 1.
    dsi_out_au_uCA_multiplier   = 1.
    dsi_out_au_uCDCA_multiplier = 1.
    dsi_out_au_uSBA_multiplier  = 1.

    dsi_out_pu_uCA_multiplier   = 1.
    dsi_out_pu_uCDCA_multiplier = 1.
    dsi_out_pu_uSBA_multiplier  = 1.
    co_out_pu_uCA_multiplier    = 1.
    co_out_pu_uCDCA_multiplier  = 1.
    co_out_pu_uSBA_multiplier   = 1.

    ######################### DEBUG #########################
    a = 1.
    b = 1.
    
    dsi_out_au_cCA_multiplier   = a* 1.26
    dsi_out_au_cCDCA_multiplier = a* 3.89
    dsi_out_au_cSBA_multiplier  = a* 2.43
    dsi_out_au_uCA_multiplier   = a* 0.71
    dsi_out_au_uCDCA_multiplier = a* 0.
    dsi_out_au_uSBA_multiplier  = a* 0.

    dsi_out_pu_uCA_multiplier   = b* 0.05
    dsi_out_pu_uCDCA_multiplier = b* 1.  
    dsi_out_pu_uSBA_multiplier  = b* 1.  
    co_out_pu_uCA_multiplier    = b* 0.05
    co_out_pu_uCDCA_multiplier  = b* 1.  
    co_out_pu_uSBA_multiplier   = b* 1.  

    # p["syn_frac_CA"]                      *= 1.
    # p["gut_deconj_freq_dsi_to_co"]        *= 1.
    # p["gut_biotr_freq_CDCA_to_CA"]        *= 1.
    ######################### DEBUG #########################
    ...
    dsi_out_au_cCA        = p["max_asbt_rate"] * x_dsi_cCA   * dsi_out_au_cCA_multiplier
    dsi_out_au_cCDCA      = p["max_asbt_rate"] * x_dsi_cCDCA * dsi_out_au_cCDCA_multiplier
    dsi_out_au_cSBA       = p["max_asbt_rate"] * x_dsi_cSBA  * dsi_out_au_cSBA_multiplier
    dsi_out_au_uCA        = p["max_asbt_rate"] * x_dsi_uCA   * dsi_out_au_uCA_multiplier
    dsi_out_au_uCDCA      = p["max_asbt_rate"] * x_dsi_uCDCA * dsi_out_au_uCDCA_multiplier
    dsi_out_au_uSBA       = p["max_asbt_rate"] * x_dsi_uSBA  * dsi_out_au_uSBA_multiplier

    dsi_out_pu_uCA        = p["gut_pu_freq_dsi"] * x_dsi_uCA     * dsi_out_pu_uCA_multiplier
    dsi_out_pu_uCDCA      = p["gut_pu_freq_dsi"] * x_dsi_uCDCA   * dsi_out_pu_uCDCA_multiplier
    dsi_out_pu_uSBA       = p["gut_pu_freq_dsi"] * x_dsi_uSBA    * dsi_out_pu_uSBA_multiplier
    co_out_pu_uCA         = p["gut_pu_freq_co"]  * x_co_uCA      * co_out_pu_uCA_multiplier
    co_out_pu_uCDCA       = p["gut_pu_freq_co"]  * x_co_uCDCA    * co_out_pu_uCDCA_multiplier
    co_out_pu_uSBA        = p["gut_pu_freq_co"]  * x_co_uSBA     * co_out_pu_uSBA_multiplier
